...
import com.example.meibank2.Adapters.TransactionAdapter;
import com.example.meibank2.Authentication.LoginActivity;
import com.example.meibank2.Authentication.RegisterActivity;
import com.example.meibank2.Database.DatabaseHelper;
import com.example.meibank2.Dialogs.AddTransactionDialog;
    ...
    private class GetSpending extends AsyncTask<Integer, Void, ArrayList<Shopping>> {
        ...
        protected ArrayList<Shopping> doInBackground(Integer... integers) {
            try {
                ...
                if (null != cursor) {
                    //TODO: moveToFirst or moveToNext?
                    if (cursor.moveToFirst()) {
